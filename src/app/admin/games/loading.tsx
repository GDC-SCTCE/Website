  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-6">
        {/* Real Filter Bar Structure (Interactive look but disabled/loading) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start animate-pulse">
          ...
          <div className="lg:col-span-2 flex flex-col gap-2">
            {[1, 2, 3].map((i) => (
              ...
              >
                {/* Thumbnail Skeleton */}
                <div className="w-[96px] h-[64px] shrink-0 border border-[#584235]/20 bg-[#1C1B1C] rounded" />

                {/* Details Skeleton */}
                <div className="flex-1 flex flex-col justify-between py-1 gap-2">
                  <div className="flex-1">
                    <div className="h-5 w-48 bg-[#584235]/40 mb-2 rounded" />
                    <div className="h-3 w-full bg-[#584235]/20 rounded" />
                  </div>
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex gap-2">
                      <div className="h-5 w-16 bg-[#584235]/30 rounded" />
                      <div className="h-5 w-12 bg-[#584235]/20 rounded" />
                    </div>
                    <div className="h-6 w-28 bg-[#584235]/30 rounded" />
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="lg:col-span-1 bg-[#1A1A1B] border border-[#584235]/30 p-6 rounded flex flex-col gap-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="h-3 w-24 bg-[#584235]/30 mb-2 rounded" />
                <div className="h-20 w-full bg-[#131314] border border-[#584235]/20 rounded" />
              </div>
