...
function GameColumn({
  ...
  return (
    ...
    >
      {/* Thumbnail */}
      <div className="relative w-full aspect-[479/400] overflow-hidden bg-[#1e1e1e]">
        {game.coverUrl && (
          <Image
            src={game.coverUrl}
            alt={game.title}
      ...
      {featuredGame && (
        <div ref={featuredRef} className="w-full bg-[#131314] mt-8">
          <div className="flex flex-col lg:flex-row min-h-[600px]">
            ...
            <div
              className="w-full lg:w-[720px] h-[400px] lg:h-auto shrink-0 relative overflow-hidden transition-all duration-800 bg-[#1e1e1e]"
              style={{
                opacity: featuredVisible ? 1 : 0,
                transform: featuredVisible ? "translateX(0)" : "translateX(40px)",
                transitionDelay: "100ms",
