...
function LeaderCard({ member, isFirst }: { member: (typeof MOCK_TEAM)[0]; isFirst: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="w-full h-full mix-blend-saturation">
      ...
      >
        ...
        {/* Name */}
        <h2 className="font-sora font-bold text-[32px] sm:text-[48px] leading-[40px] sm:leading-[53px] tracking-[-0.96px] uppercase text-[#E5E2E3] m-0 mb-[4px]">
          {member.name}
        </h2>
...
function MemberCard({ member }: { member: (typeof MOCK_TEAM)[0] }) {
  return (
    <div className="w-full max-w-[270px] h-[376px] bg-[#1C1B1C] border border-transparent transition-all duration-[250ms] ease-out hover:-translate-y-1 hover:shadow-[0_12px_24px_rgba(0,0,0,0.6)] hover:border-[#FF7A00] relative shrink-0 box-border mx-auto">
      ...
      {/* Photo container */}
      <div className="w-full h-[300px] relative mix-blend-saturation overflow-hidden">
