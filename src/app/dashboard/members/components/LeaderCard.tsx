...
export function LeaderCard({
  ...
  return (
    <div
      className="w-full shrink-0 flex transition-all duration-700"
      style={{
        opacity: visible ? 1 : 0,
    ...
    >
      <div
        className={`w-full ${cardWidth} h-auto lg:h-[553px] bg-[#1C1B1C] border border-[#201F20] transition-all duration-[250ms] ease-out hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(255,122,0,0.15)] hover:border-[#FF7A00] shrink-0 flex flex-col lg:flex-row relative group/card`}
      >
