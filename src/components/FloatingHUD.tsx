...
export default function FloatingHUD() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group flex items-center gap-3 pointer-events-none">
      {/* Tooltip Label */}
      ...
      <Link
        ...
        className="pointer-events-auto w-14 h-14 rounded-full flex items-center justify-center bg-[#1C1B1C]/95 text-[#FFB68B] border border-[#584235] hover:border-[#FFB68B] hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(255,122,0,0.15)] transition-all duration-300"
